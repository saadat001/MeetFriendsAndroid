...
public class Myconstant
{
    ...
    public static String Root_url="https://websoftquality.com/meetfriends/public/api/";
    public static String LoginApi="loginnew";
    public static String SignupApi="signupnew";
